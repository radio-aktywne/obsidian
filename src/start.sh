...
# Configuration
host="${OBSIDIAN__SERVER__HOST:-0.0.0.0}"
sqlport="${OBSIDIAN__SERVER__PORTS__SQL:-20110}"
httpport="${OBSIDIAN__SERVER__PORTS__HTTP:-20111}"
rpcport="${OBSIDIAN__SERVER__PORTS__RPC:-20112}"
